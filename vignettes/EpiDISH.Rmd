...
After estimate cell-type fractions, we can identify differentially methylated cell-types and their directionality of change using **CellDMC** [@CellDMC]function. The workflow of **CellDMC** is shown below.
